{{
'   fsrw.spin 1.2  29 December 2006   Radical Eye Software
'
...
'   your setup.
   ...
   return constant(((2006-1980) << 25) + (12 << 21) + (29 << 16) + (12 << 11))
...
' this code will eventually be moved to seek
   ...
   brwword(at+26, -1)
   i := pdate
   brwlong(at+$e, i) ' write create time and date
   brwlong(at+$16, i) ' write last modified date and time
