{{
fsrw 1.5 by Radical Eye Software
...
I see speeds of between 271 to 430 KBytes/sec.  For writes, I see
speeds of between 114 to 310 KBytes/sec, depending on the card.
